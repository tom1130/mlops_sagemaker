...
class PrTrainingProcess(Preprocess):
    ...
    def execution(self):
        ...
        self.logic(df, label)
        print('pr training preprocess process is completed')
...
if __name__=='__main__':
    try:
        ...
        parser.add_argument('--lounge_name', default='PR')
        ...
        publish_sns(
            ...
            error_type="PR Preprocess Step 실행 중 에러",
            error_message=e,
            env=args.env,
        )
