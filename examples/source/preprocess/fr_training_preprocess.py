...
class FrTrainingProcess(Preprocess):
    ...
    def logic(self, df, label):
        ...
        # test data의 경우, transform job의 활용을 위해 data와 label 분리
    ...
    def execution(self):
        ...
        self.logic(df, label)
        print('fr training preprocess process is completed')
...
if __name__=='__main__':
    try:
        ...
        publish_sns(
            ...
            error_type="FR Preprocess Step 실행 중 에러",
            error_message=e,
            env=args.env,
        )
